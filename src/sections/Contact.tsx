...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={root} className="theme-fade bg-base-veil py-20 md:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-feature px-6 py-16 md:px-14 md:py-20">
          <div
            aria-hidden="true"
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            <h2
              data-contact-reveal
              className="mt-5 font-display text-3xl uppercase leading-[1.05] text-on-feature sm:text-4xl lg:text-5xl"
            >
              {contact.heading}
            </h2>
            ...
            <p data-contact-reveal className="mt-6 text-sm text-on-feature/50">
              {contact.support}
            </p>
          </div>
        </div>
