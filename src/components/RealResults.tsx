      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="font-inter text-lg text-navy-foreground/70 max-w-3xl mx-auto">
              We Booked 11 Emergency Calls in the First Month That Would Have Gone to Competitors
            </p>
          </div>

          {/* Case Study Grid */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {real_results.map((casestudy, index) => (
              <div
                key={index}
